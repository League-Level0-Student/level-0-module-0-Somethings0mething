...
size(750, 500);
 // The following code loads the image into the program
  PImage baby = loadImage("Gear.jpeg");
...
textSize(45);
text("You know what really grinds my gears?", 10, 50);
...
if(mousePressed){
 textSize(20);
 text("Whenever someone goes and adds a laugh track and expects you to laugh with it.", 50, 450);
